...
<main class="relative w-screen h-screen flex flex-col items-center bg-yellow-50">
    ...
    <form action="{{ route('register.step2') }}" method="POST">
        @csrf
        <div class="my-6">
            <label for="origin_story" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Write your
                origin story here:</label>
        ...
        <div class="my-6">
            <label for="motivation" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Write your
                motivation for heroism here:</label>
