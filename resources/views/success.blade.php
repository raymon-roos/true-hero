...
<main class="min-h-screen min-w-screen flex flex-col items-center p-10 bg-black">
    <header class="flex flex-col items-center">
        <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-50 md:text-5xl lg:text-6xl">
            Success!</h1>
        <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Your
            registration form has been sent. Click below to continue</p>
        <a href="/"
