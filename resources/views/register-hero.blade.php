...
<main class="min-h-screen min-w-screen flex flex-col items-center p-10 bg-black">
    ...
    <form action="{{ route('register.hero.step1') }}" method="POST">
        @csrf
        <div class="my-6">
        ...
        <div class="my-6">
            ...
            <div class="relative">
                ...
                <input type="text" id="phone_number" name="phone_number" name="phone_number"
                    ...
                    pattern="(?:\+31|0)6[\s-]?[1-9]\d{1}[\s-]?\d{2}[\s-]?\d{2}[\s-]?\d{2}"
                    title="Enter a valid Dutch phone number.">
            </div>
        </div>
