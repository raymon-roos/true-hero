...
<main class="min-h-screen min-w-screen flex flex-col items-center p-10 bg-black">
    ...
    <form action="{{ route('register.hero.step2') }}" method="POST">
        ...
        <button id="backbutton" type="button"
            class="px-5 py-2.5 text-sm font-medium text-gray-50 border-2 border-red-700 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 rounded-lg text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
            < Previous</button>
